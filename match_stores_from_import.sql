...
-- Step 1: Create the table to store matched results
...
-- Step 2: Create the extension for text matching if it doesn't exist
CREATE EXTENSION IF NOT EXISTS pg_trgm;

-- Step 3: Create function to match stores using partial text matching
...
BEGIN
  -- Delete existing records instead of truncating to avoid foreign key issues
  DELETE FROM matched_stores;
...
-- Step 4: Create helper function to view matched stores
...
-- Step 5: Create helper function to view unmatched stores
...
--
-- To view matched stores:
-- SELECT * FROM view_matched_stores();
--
-- To view unmatched stores:
